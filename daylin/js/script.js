...
monogatari.script ({
	...
	'nextslide':[
        'Moreover, Sugihara saw that Lithuania was a strategic location as it could function as a faraway for Western Europeans to escape through an eastern route through the Soviet Union to Japan.','After Germany had invaded Poland and started persecuting the Jewish people there, many of the Jewish people fled eastward to escape, with 15,000  arriving in Lithuania, which was still independent at the time.','When the Soviets occupied Lithuania in 1940, the Jewish people’s circumstances became direr and Sugihara was confronted with the urgency of their situation when a Jewish delegation, headed by Zerach Warhaftig, a Jewish refugee, came to the consulate to meet with him.','Sugihara agreed to meet for a brief conversation, during which the Jewish community expressed their desperate need to obtain immigration visas to anywhere in the world in order to escape imminent death.','During their search, the Jewish people found out that Curacao, a Dutch colony, did not require visas, which would allow them to leave Lithuania; however, since the war blocked all travel in the western region, the Jewish community wanted to request help to travel along an eastward route by obtaining transit visas from the Japanese Consulate.','With these visas, the Jewish people would be able to obtain permission to cross the Soviet Union and begin their journey.','jump choiceScreen', 
	...
	'Closing':[
		'show background crycat with fadeIn','In the period preceding his passing, Sugihara, the former Japanese consul in Lithuania, was recognized by Yad Vashem, the Holocaust Martyrs and heros Remembrance Authority in Israel, as Righteous Among the Nations for his assistance to refugees during World War II. The title was bestowed upon him by Yad Vashem in 1984, and a ceremony was held in Jerusalem in January 1985 to honor his contributions.','Sugihara’s wartime experience demonstrates that the courage of one individual who follows their moral compass can make an incredible difference.','His actions alone saved the lives of so many.','Trusting ones own judgment of right and wrong at times is required when the law or government sanctifies something that is unjust.','jump choiceScreen',
	]
});
